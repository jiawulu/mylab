            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="company.ftc.label" default="Ftc" /></td>
                            
                            <td valign="top" class="value"><g:link controller="company" action="show" id="${companyInstance?.ftc?.id}">${companyInstance?.ftc?.encodeAsHTML()}</g:link></td>

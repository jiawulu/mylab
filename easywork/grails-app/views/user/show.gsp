            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="user.leader.label" default="Leader" /></td>
                            
                            <td valign="top" class="value"><g:link controller="user" action="show" id="${userInstance?.leader?.id}">${userInstance?.leader?.encodeAsHTML()}</g:link></td>

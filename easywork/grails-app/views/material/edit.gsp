                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: materialInstance, field: 'name', 'errors')}">
                                    <g:textField name="name" value="${materialInstance?.name}" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="unit"><g:message code="material.unit.label" default="Unit" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: materialInstance, field: 'unit', 'errors')}">
                                    <g:textField name="unit" value="${materialInstance?.unit}" />
                                </td>
                            </tr>
